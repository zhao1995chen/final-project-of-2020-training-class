 ...
 * @author Chang
 */
@WebServlet(name = "MoneyTableServlet", urlPatterns = {"/MoneyTableServlet"})
public class MoneyTableServlet extends HttpServlet {
    MoneyTableDAO MDAO = new MoneyTableDAO();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MoneyTableServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            MDAO.create();
            out.println("<h1>Servlet MoneyTableServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
