...
//		System.out.println("aioCheckOutWebATM: " + genAioCheckOutWebATM());
	...
	public static String postCreateServerOrder(){
		...
		obj.setMerchantTradeNo("testCom2");
		obj.setMerchantTradeDate("2020/08/14 10:23:46");
	...
	public static String postFundingReconDetail(){
		...
		obj.setStartDate("2020/08/14");
		obj.setEndDate("2020/08/14");
	...
	public static String postTradeNoAio(){
		...
		obj.setDateType("6");
		obj.setBeginDate("2020/08/7");
		obj.setEndDate("2020/08/7");
	...
	public static String genAioCheckOutALL(){
		...
		obj.setMerchantTradeNo("testComp1");
